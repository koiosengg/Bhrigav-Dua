...
import HotstarVideo from "../../assets/Cinematography/Work/Hotstar/Hotstar1.mp4";

function FiMoney() {
  return (
    <div className="work-set">
      <div className="work-set-heading">
        <h2>Akshay ka naya cop avatar | Cuttputlli | DisneyPlus Hotstar</h2>
      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        <article className="cinematography-work-set">
          <a
            href="https://www.youtube.com/watch?v=S-MCo2hLpIk"
            target="_blank"
            rel="noopener noreferrer"
            className="work-set-video"
            aria-label="Watch on YouTube"
          >
            <video src={HotstarVideo} autoPlay muted loop playsInline />
          </a>
        </article>
        <article className="cinematography-work-set">
