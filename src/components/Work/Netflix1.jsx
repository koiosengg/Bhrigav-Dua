...
import NetflixVideo from "../../assets/Cinematography/Work/Netflix/Netflix2.mp4";

function Netflix1() {
  return (
    <div className="work-set">
      <div className="work-set-heading">
        <h2>Netflix - Mohanrajs React to Never Have I Ever Season 2</h2>
      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        <article className="cinematography-work-set">
          <a
            href="https://www.youtube.com/watch?v=-dp2v3wRzvE"
            target="_blank"
