  ...
  if (imagesSubset.length === 1) {
    return (
      <div className="crossfade-container">
        <img src={imagesSubset[0]} alt="Prime Video campaign thumbnail" className="crossfade-img current" />
      </div>
    );
  }
        ...
        <article className="cinematography-work-set">
          <div className="work-set-video">
            <iframe
              ...
              src="https://www.youtube-nocookie.com/embed/dfTTphws0GI?autoplay=1&cc_load_policy=0&mute=1&loop=1&playlist=dfTTphws0GI&controls=1&modestbranding=1&rel=0"
