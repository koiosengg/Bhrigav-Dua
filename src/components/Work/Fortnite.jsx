    ...
    <div className="work-set">
      ...
      <div className="cinematography-work-grid other-work-grid">
        <article className="cinematography-work-set">
          <img src={Image1} alt="Fortnite Work Image" />
        </article>
        <article className="cinematography-work-set">
          <img src={Image2} alt="Fortnite Work Image" />
        </article>
        <article className="cinematography-work-set">
          <img src={Image3} alt="Fortnite Work Image" />
        </article>
        <article className="cinematography-work-set">
          <img src={Image4} alt="Fortnite Work Image" />
        </article>
        <article className="cinematography-work-set">
          <img src={Image5} alt="Fortnite Work Image" />
        </article>
      </div>
    </div>
  );
