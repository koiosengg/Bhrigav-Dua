  ...
  if (imagesSubset.length === 1) {
    return (
      <div className="crossfade-container">
        <img src={imagesSubset[0]} alt="Emperium campaign thumbnail" className="crossfade-img current" />
      </div>
    );
  }
  ...
  return (
    <div className="work-set">
      <div className="work-set-heading">
        <h2>
          <span>Emperium Developers:</span> Apnepan Wali Diwali
        </h2>
        <p>DOP</p>
      </div>
      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        <article className="cinematography-work-set">
          <div className="work-set-video">
            <iframe
              src="https://www.youtube.com/embed/UqhSxRo05NU?autoplay=1&cc_load_policy=3&mute=1&loop=1&playlist=UqhSxRo05NU&controls=1&modestbranding=1&rel=0"
