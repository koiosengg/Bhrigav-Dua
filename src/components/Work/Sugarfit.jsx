      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        <article className="cinematography-work-set">
          <div className="work-set-video">
            <iframe
              src="https://www.youtube.com/embed/_KXqJA_5szM?autoplay=1&cc_load_policy=3&mute=1&loop=1&playlist=_KXqJA_5szM&controls=1&modestbranding=1&rel=0"
