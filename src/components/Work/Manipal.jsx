...
import ManipalVideo from "../../assets/Cinematography/Work/Manipal/Manipal1.mp4";

function Manipal() {
  return (
    <div className="work-set">
      <div className="work-set-heading">
        <h2>#AzadiWaliDegree | Online Manipal</h2>
      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        <article className="cinematography-work-set">
          <a
            href="https://www.youtube.com/watch?v=-xL7uRU_rno"
            target="_blank"
            rel="noopener noreferrer"
            className="work-set-video"
            aria-label="Watch on YouTube"
          >
            <video src={ManipalVideo} autoPlay muted loop playsInline />
          </a>
        </article>
        <article className="cinematography-work-set">
