...
import Img4 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img4.png";
import Img5 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img5.png";
import Img6 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img6.png";
import Img7 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img7.png";
import Img8 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img8.png";
import Img9 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img9.png";
import Img10 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img10.png";
import Img11 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img11.png";
import Img12 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img12.png";
import Img13 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img13.png";
import Img14 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img14.png";
import Img15 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img15.png";
import Img16 from "../../assets/Cinematography/Work/TataCommercial/TataIndra/Img16.png";
  ...
  return (
    <div className="work-set">
      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        {/* Corner 3 — top-right */}
        <article className="cinematography-work-set">
          <CrossfadeImages imagesSubset={images.slice(4, 8)} startDelay={2000} />
        </article>

        {/* Corner 4 — bottom-left */}
        <article className="cinematography-work-set">
          <CrossfadeImages imagesSubset={images.slice(8, 12)} startDelay={4000} />
        </article>

        {/* Corner 5 — bottom-right */}
        <article className="cinematography-work-set">
          <CrossfadeImages imagesSubset={images.slice(12, 16)} startDelay={6000} />
        </article>
      </div>
    </div>
  );
