  ...
  if (imagesSubset.length === 1) {
    return (
      <div className="crossfade-container">
        <img src={imagesSubset[0]} alt="Licious campaign thumbnail" className="crossfade-img current" />
      </div>
    );
  }
  ...
  return (
    <div className="work-set">
      <div className="work-set-heading">
        <h2>
          <span>Licious:</span> Sorry Dads | Happy Father's Day from Licious
        </h2>
      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        <article className="cinematography-work-set">
          <div className="work-set-video">
            <iframe
              title="Licious: Sorry Dads | Happy Father's Day from Licious"
              src="https://www.youtube-nocookie.com/embed/OTKNrJE94rI?autoplay=1&cc_load_policy=0&mute=1&loop=1&playlist=OTKNrJE94rI&controls=1&modestbranding=1&rel=0"
