...
import Img1 from "../../assets/Cinematography/Work/Komfort 1/Img1.webp";
import Img2 from "../../assets/Cinematography/Work/Komfort 1/Img2.webp";
import Img3 from "../../assets/Cinematography/Work/Komfort 1/Img3.webp";
import Img4 from "../../assets/Cinematography/Work/Komfort 1/Img4.webp";
import Img5 from "../../assets/Cinematography/Work/Komfort 1/Img5.webp";
import Img6 from "../../assets/Cinematography/Work/Komfort 1/Img6.webp";
  ...
  return (
    <div className="work-set">
      <div className="work-set-heading">
        <h2>
          <span>Komfort:</span> Collection 1
        </h2>
        <p>DOP</p>
      </div>
      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        <article className="cinematography-work-set">
          <div className="work-set-video">
            <iframe
              title="Komfort: Collection 1"
              src="https://www.youtube-nocookie.com/embed/NLJV0bQ6W-4?autoplay=1&cc_load_policy=0&mute=1&loop=1&playlist=NLJV0bQ6W-4&controls=1&modestbranding=1&rel=0"
