...
import GooglePlayVideo from "../../assets/Cinematography/Work/GooglePlay/GooglePlay.mp4";
  ...
  return (
    <div className="work-set">
      <div className="work-set-heading">
        <h2>Google Play Squad Tournament</h2>
        <p>DOP</p>
      </div>
      ...
      <div className="cinematography-work-grid other-work-grid">
        ...
        <article className="cinematography-work-set">
          <a
            href="https://youtu.be/bVTTcsQOPfE"
            target="_blank"
            rel="noopener noreferrer"
            className="work-set-video"
            aria-label="Watch on YouTube"
          >
            <video src={GooglePlayVideo} autoPlay muted loop playsInline />
          </a>
        </article>
        <article className="cinematography-work-set">
